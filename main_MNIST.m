...
% network function
cnnF_list = {@make_cnn_dct_lpf @make_cnn @make_cnn_fft_lpf @make_cnn_oa @make_cnn_average};


%% End User Interface

% process user interface
[train_set, test_set, data_settings] = load_mnist(num_train, num_test);
